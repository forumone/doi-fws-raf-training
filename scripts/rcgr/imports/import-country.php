...
/**
 * @file
 * Script to import country terms from a CSV file.
 */
...
// Define the mapping for the country vocabulary.
$mapping = [
  'vid' => 'country',
  'csv_file' => 'rcgr_ref_country_202503031405.csv',
  'name_field' => 'ref_cd',
  ...
  'skip_row_callback' => function ($row, $row_number, $column_indices) {
    ...
    // Skip rows with empty country codes.
...
Drush::logger()->notice("Country taxonomy import completed.");
