 ...
 * the Drupal installation directory and be accessible over the web.
 */
$settings['file_public_path'] = 'sites/manatee/files';
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/doifws/fws_manatee-settings.inc';
}

$settings['config_sync_directory'] = '../config/sync/manatee';

# in production this will be over-ridden by platform-settings.php
$settings['session.cookie_path'] = '/manatee';
$settings['file_public_path'] = "sites/manatee/files";
$settings['file_private_path'] = "sites/manatee/files/private";
$settings['file_temp_path'] = "/tmp";
